...
const ARTIFACTS = [
  ...
  {
    id: 'Pangil',
    title: 'Sacred Stone of Pangil',
    muni: 'Pangil',
    category: 'Cultural Heritage Artifact / Sacred Stone',
    era: 'Pre-colonial',
    palette: 'p1',

    short: 'A legendary stone deeply woven into Pangil\'s identity, the Bato ng Pangil stands as a symbol of the town\'s rich folklore, ancestral memory, and enduring cultural heritage.',
    long1: 'The Bato ng Pangil is a naturally occurring stone associated with local legends and historical narratives of Pangil, Laguna. Revered as a cultural landmark, it serves as a tangible reminder of the community\'s folklore, traditions, and historical roots.',

    sig1: 'Regarded as one of Pangil\'s traditional heritage landmarks, the Bato ng Pangil embodies the town\'s oral history and collective memory. The stone has long been associated with stories passed down through generations and remains an important symbol of Pangil\'s cultural identity and connection to its ancestral past..',

    material: 'Natural stone',
    dimensions: 'Not publicly documented',
    dateRange: 'Undetermined (Pre-colonial association through local tradition)',
    location: 'Pangil, Laguna, Philippines',
    condition: 'Preserved as a local heritage landmark',
    accession: 'LAG-PAN-003'
  },
  ...
  {
    id: 'Kalayaan',
    title: 'Kalayaan Centennial Monument',
    muni: 'Kalayaan',
    category: 'Historical Monument / Commemorative Structure',
    era: 'Contemporary Period',
    palette: 'p3',

    short: 'A commemorative landmark that embodies the history, identity, and collective memory of Kalayaan, serving as a lasting symbol of the municipality\'s heritage and community pride.',
    long1: 'The Kalayaan Centennial Monument is a civic monument erected to commemorate the municipality\'s historical milestones and cultural legacy. As a prominent landmark in the town center, it stands as a visual representation of Kalayaan\'s identity and its enduring sense of unity and heritage.',

    sig1: 'The monument serves as a permanent reminder of Kalayaan\'s historical development and the community\'s shared journey through time. It commemorates significant events in the municipality\'s history and reinforces the importance of preserving local heritage, historical memory, and civic identity for future generations. The municipality itself traces its roots to the former town of Longos, which was officially renamed Kalayaan in 1956.',
    
    material: 'Concrete and masonry',
    dimensions: 'Not publicly documented',
    dateRange: 'Contemporary Period',
    location: 'Municipal Plaza, Kalayaan, Laguna',
...
function renderArtifactDetail(id){
  ...
  document.getElementById('artMiniGallery').innerHTML = [1,2,3,4].map(() => `
    <div class="plate ${a.palette}"><div class="plate-pattern pattern-topo" style="position:absolute;inset:0;"></div></div>`).join('');
